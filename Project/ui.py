...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.add_after = QtWidgets.QPushButton(self.frame_2)
        self.add_after.setGeometry(QtCore.QRect(0, 140, 221, 30))
        self.add_after.setFont(styles.font_ltl_btn)
        self.add_after.setMouseTracking(False)
        self.add_after.setText('Добавить перед')
        self.add_after.setVisible(False)
        self.add_after.setStyleSheet(styles.for_btn)
        self.add_after.setCheckable(False)
        self.add_after.setObjectName("add_act_2")
