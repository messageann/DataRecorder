...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.all_scenes.setGeometry(QtCore.QRect(20, 20, 261, 41))
        font = QtGui.QFont()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.add_act.setText(_translate("MainWindow", "Добавить действие"))
        self.save.setText(_translate("MainWindow", "Сохранить"))
        self.record_2.setText(_translate("MainWindow", "Записывать данные на шаге"))
        self.add_act_2.setText(_translate("MainWindow", "Автоматически добавить фазу отдыха"))
